...
{{source:src/test/java/tests/LoginTest.java}}
...
{{source:src/test/java/base/BaseTest.java}}
...
{{source:src/main/java/pages/LoginPage.java}}
...
<details><summary>自测：为什么不让 CartTest 依赖 LoginTest 先成功运行？</summary>
