...
{{source:src/test/java/api/BookingData.java}}
...
{{source:src/test/java/api/BaseApiTest.java}}
...
{{source:src/main/java/api/ApiTrace.java}}
...
<details><summary>自测：owned.clear() 执行成功，能否证明预约已删除？</summary>
